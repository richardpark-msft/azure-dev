...
type UsageMetrics struct {
	...
	// nano-AIU totals. This is the user-facing billing signal when available.
	AICredits float64
...
func (u UsageMetrics) String() string {
	...
	if u.AICredits > 0 {
		lines = append(lines, output.WithGrayFormat("  • AI credits:       %s", formatAICredits(u.AICredits)))
	}
