...
const (
	...
	ProjectService_AddLayer_FullMethodName                 = "/azdext.ProjectService/AddLayer"
	...
	ProjectService_GetService_FullMethodName               = "/azdext.ProjectService/GetService"
...
type ProjectServiceClient interface {
	...
	AddLayer(ctx context.Context, in *AddLayerRequest, opts ...grpc.CallOption) (*LayerResponse, error)
...
func (c *projectServiceClient) AddLayer(ctx context.Context, in *AddLayerRequest, opts ...grpc.CallOption) (*LayerResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LayerResponse)
	err := c.cc.Invoke(ctx, ProjectService_AddLayer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *projectServiceClient) GetService(ctx context.Context, in *GetServiceRequest, opts ...grpc.CallOption) (*GetServiceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetServiceResponse)
	err := c.cc.Invoke(ctx, ProjectService_GetService_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProjectServiceServer interface {
	...
	// AddLayer adds or updates an infrastructure-backed project layer.
	AddLayer(context.Context, *AddLayerRequest) (*LayerResponse, error)
	// GetLayer gets a resolved project layer. An empty name addresses the implicit layer.
...
func (UnimplementedProjectServiceServer) AddLayer(context.Context, *AddLayerRequest) (*LayerResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddLayer not implemented")
}
...
func (UnimplementedProjectServiceServer) GetService(context.Context, *GetServiceRequest) (*GetServiceResponse, error) {
...
func _ProjectService_AddLayer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddLayerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProjectServiceServer).AddLayer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProjectService_AddLayer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProjectServiceServer).AddLayer(ctx, req.(*AddLayerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ProjectService_GetService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetServiceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProjectServiceServer).GetService(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProjectService_GetService_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProjectServiceServer).GetService(ctx, req.(*GetServiceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProjectService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddLayer",
			Handler:    _ProjectService_AddLayer_Handler,
		},
		{
			MethodName: "GetLayer",
		...
		},
		{
			...
			Handler:    _ProjectService_GetService_Handler,
		},
		{
